...
const nam = [{
    ...
    message: ['~এখন সকাল ১০টা বাজে মিস করছি তোমাদের  ']
						 ...
						 {
    timer: '12:00:00 PM',
    message: ['~এখন সকাল ১১টা বাজে কি করছো সবাই ']
},					
						 {
    timer: '1:00:00 PM',
    message: ['~এখন দুপুর ১২টা বাজে আর এক ঘন্টা পর যোহরের আজান দিবে ❤️ ']
},
						 {
    timer: '2:00:00 PM',
    ...
    message: ['~এখন দুপুর ২টা বাজে গোসল করে সবাই দুপুরের খাবার খেয়ে নাও ☺️']
						 ...
						 {
    timer: '4:00:00 PM',
    message: ['~এখন দুপুর ৩টা বাজে একটূ রেস্ট নাও ❤️']
},
						{
    timer: '5:00:00 PM',
    ...
    message: ['এখন সন্ধ্যা ৭ টা বাজে কি করছো সবাই এখন এশার আযান দিবে সবাই নামাজ পড়ে নাও❤️']
             ...
             {
    timer: '9:00:00 PM',
    message: ['~এখন রাত ৮টা বাজে অনেক শীত লাগছে']
},
             {
    timer: '10:00:00 PM',
